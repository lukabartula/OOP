package org.example.week10.lab.Events;
...
// mozda zbog ovog filea me zezao git, nije htio da se pusha kod

public class Events {
    private static final String[] EVENT_TYPES = {"Login", "Logout", "Purchase", "ViewPage", "Error"};
    private static final int NUM_OF_RECORDS = 1000;
    ...
    public static void main(String[] args) throws IOException {
        //specify the file name, "events.txt"
